...
Load and follow `references/flows-workflow.md` (init mode). That file is self-contained:
domain detection → AskUserQuestion if ambiguous → generate `docs/flows/<domain>-flow.md` per domain.
