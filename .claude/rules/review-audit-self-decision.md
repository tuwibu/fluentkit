...
**Proceeding ≠ proceeding silently.** When you take the ≥85% path and act without asking, you still made a judgment call for the user. Disclose it in the end-of-turn decisions block per `surface-silent-decisions.md` so the user can override. Acting directly saves a question; it does not waive transparency.
